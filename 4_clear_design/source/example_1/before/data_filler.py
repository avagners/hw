...
class DataFiller(HDFSCommand):
    ...
    def _rollback_copy_partition(self, partitions: List[str]) -> None:
    ...
    def _rollback_update_hive_metadata(self, partitions: List[str],
                                       table_name: str) -> None:
    ...
    def _copy_partition(self, source_partition: str,
    ...
    def _update_hive_metadata(self, partitions: List[str], table_name: str) -> None:
    ...
    def _update_hive_statistics(self, partitions: List[str], table_name: str) -> None:
    ...
    def _add_vita_status(self, partitions: List[str],
